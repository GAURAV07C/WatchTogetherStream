...
export default function ChatSidebar({ socket, roomId, username, messages, typingUsers }: ChatSidebarProps) {
  ...
  return (
    <div className="w-full flex flex-col h-full overflow-hidden">
      ...
      <div className="p-2 md:p-4 border-t border-border flex-shrink-0">
